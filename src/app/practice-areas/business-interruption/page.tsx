      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Business Interruption Expert Witness"
            fill
        ...
        <div className="container-custom relative z-10 text-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white mb-8 tracking-tighter leading-[1.1]">
              Business <br />
              <span className="font-serif italic font-medium text-gold drop-shadow-[0_0_15px_rgba(212,175,55,0.3)]">Interruption</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-12 xl:col-span-7 flex flex-col justify-center lg:pt-10">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-950 mb-8 leading-tight tracking-tight uppercase font-sans">
                Forensic Evaluation of <br />
                <span className="font-serif italic text-primary-900 normal-case font-medium">Business Interruption Claims</span>
              </h2>
              <div className="space-y-6 text-xl text-gray-800 leading-relaxed font-light">
                <p>
                  Business litigators and insurance companies often turn to forensic accountants to evaluate business interruption claims and Engel & Engel has extensive experience in evaluating these types of claims for both plaintiffs and defendants.
                </p>
                <p>
                  Engel & Engel has served as an expert in connection with business interruption claims in a wide variety of industries. Overall, Engel & Engel has the qualifications and experience to prepare damage analyses and mitigation analyses in connection with business interruption claims that are consistent with established financial principles and are able to withstand the scrutiny of the court.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight tracking-tight uppercase">
              How Engel & Engel Helps <span className="font-serif italic text-gold normal-case font-medium">Litigation Attorneys in Business Interruption Claims</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-primary-950 mb-8 tracking-tighter uppercase leading-tight font-sans">
                Comprehensive <br />
                <span className="font-serif italic text-primary-900 normal-case font-medium">Damage Analysis</span>
              </h2>
              <div className="space-y-6 text-xl text-gray-700 leading-relaxed font-light">
                <p>
                  Our team brings sophisticated financial modeling and deep forensic insight to every business interruption claim. We meticulously reconstruct economic realities to quantify losses that withstand the most rigorous legal challenges.
                </p>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="relative h-[400px] w-full bg-gray-100 shadow-2xl overflow-hidden rounded-sm"
            >
              <Image
                src="https://images.unsplash.com/photo-1450101499163-c8848c66ca85?auto=format&fit=crop&q=80&w=1200"
                alt="Business Interruption Analysis"
                fill
