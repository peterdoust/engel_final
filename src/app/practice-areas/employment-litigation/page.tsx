...
export default function EmploymentLitigationPage() {
  ...
  return (
    <main className="bg-white">
      ...
      <SchemaMarkup type="ProfessionalService" data={{ name: "Employment Litigation Expert Witness Services", description: "Forensic analysis and calculation of economic damages in employment litigation.", serviceType: "Forensic Accounting - Employment Litigation", address: { street: "11766 Wilshire Blvd, Suite 1170", zip: "90025" } }} />
      ...
      <section className="relative min-h-[60vh] flex items-center justify-center overflow-hidden pt-20">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Employment Litigation Expert Witness"
            fill
          ...
          >
            ...
            <div className="flex items-center justify-center space-x-6 mb-12 overflow-hidden max-w-2xl mx-auto">
              ...
              <h2 className="text-sm md:text-base font-bold text-primary-100 tracking-[0.4em] uppercase whitespace-nowrap">
                Economic Damages & Mitigation Analysis
              </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            ...
            <div className="lg:col-span-12 xl:col-span-7 flex flex-col justify-center lg:pt-10">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-950 mb-8 leading-tight tracking-tight uppercase">
                ...
                <span className="font-serif italic text-primary-900 normal-case font-medium">Employment Damages</span>
              </h2>
              <div className="space-y-6 text-xl text-gray-800 leading-relaxed font-light">
                <p>
                  Engel & Engel has extensive expertise and experience in analyzing and calculating economic damages in employment litigation matters for both plaintiffs and defendants.
                </p>
                <p>
                  Our expertise is highlighted with our research publication, “Framework for the Calculation of Employment Damages”. Overall, Engel & Engel has the qualifications and experience to prepare damage and mitigation analyses that are consistent with established legal principles and are able to withstand the scrutiny of the court.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight tracking-tight uppercase">
              How Engel & Engel Helps <span className="font-serif italic text-gold normal-case font-medium">Employment Litigation Attorneys</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
            {serviceItems.map((service, index) => (
              <motion.div
                ...
                className="group p-8 border border-white/10 bg-white/5 backdrop-blur-sm hover:border-gold/50 transition-all duration-500 relative min-h-[160px] flex items-center justify-center text-center"
              >
      ...
      <section className="py-24 md:py-32 bg-white relative overflow-hidden">
        <div className="container-custom relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <Image
                src="https://images.unsplash.com/photo-1454165833767-027ffea9e573?auto=format&fit=crop&q=80&w=1200"
                alt="Employment Litigation Research"
                fill
