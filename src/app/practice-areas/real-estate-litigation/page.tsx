    ...
    <main className="bg-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
              ...
              <div className="relative inline-block mb-10">
                ...
                <div className="relative z-10 bg-primary-950 text-white p-10 md:p-14 rounded-sm shadow-2xl">
                  ...
                  <p className="text-primary-100 text-lg leading-relaxed font-light">
                    Three decades of uncompromising financial integrity and forensic excellence in Los Angeles.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-12 xl:col-span-7 flex flex-col justify-center lg:pt-10">
              <h2 className="text-4xl md:text-5xl font-bold text-primary-950 mb-8 leading-tight tracking-tight uppercase">
                Real Estate <br />
                <span className="font-serif italic text-primary-900 normal-case font-medium">Forensic Accounting Expertise</span>
              </h2>
      ...
      <section className="relative py-24 md:py-32 bg-primary-950 overflow-hidden text-white shadow-[0_8px_40px_rgba(0,0,0,0.25)]">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <span className="inline-block text-gold font-bold tracking-[0.5em] uppercase text-xs mb-6 px-4 py-1 border border-gold/30 rounded-full">Core Services</span>
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-8 leading-tight tracking-tight uppercase">
              How Engel & Engel Helps <span className="font-serif italic text-gold normal-case font-medium">Real Estate Litigation Attorneys</span>
            </h2>
      ...
      {/* Authority Section / Visual Divider */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold text-primary-950 mb-8 tracking-tighter uppercase leading-tight font-sans">
                ...
                <span className="font-serif italic text-primary-900 normal-case font-medium">High-Stakes Real Estate</span>
              </h2>
              <p className="text-xl text-gray-700 leading-relaxed font-light">
                Our team brings uncompromising financial integrity to every case, whether representing developers, brokers, or property owners. We provide forensic analysis consistent with established financial principles, ensuring our findings withstand the most rigorous scrutiny of the court.
              </p>
            </motion.div>
            ...
            >
              <Image
                src="https://images.pexels.com/photos/443383/pexels-photo-443383.jpeg?auto=compress&cs=tinysrgb&w=1200"
                alt="Commercial Luxury Real Estate"
                fill
